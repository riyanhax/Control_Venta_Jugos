...
from IQ_option.binary.iq import fast_data,higher,lower,login
from IQ_option.binary.training import train_data
...
def preprocess_prediciton(iq):
    Actives = ['EURUSD-OTC', 'GBPUSD-OTC', 'EURJPY-OTC', 'AUDUSD-OTC']
    active = 'EURUSD-OTC'
    main = pd.DataFrame()
