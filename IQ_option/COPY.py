...
for i in range(1, 1000):
    ...
    for colocacao in data['result']['positional']:
        ...
        if (int(metodo) == 1 and primeiro_nome.lower() in nome_ranking.lower()) or (
                int(metodo) == 2 and primeiro_nome.lower() in nome_ranking.lower() or outro_nome.lower() in
                segunda_busca['user_name'].lower()) or (
                int(metodo) == 3 and primeiro_nome.lower() in nome_ranking.lower() and outro_nome.lower() in
                segunda_busca['user_name'].lower()):
            ...
            print(' Imagem de perfil:',
                  (segunda_busca['img_url'] if segunda_busca['img_url'] != '' else 'Imagem nao disponivel'))
