...
# #:===============================================================:#
login = 'yordantarazona23@gmail.com'
password = '1004925617*Cy'
...
print('#:===============================================================:#')
print(f'Executando estratégia VITUXO 2.0 MAIORIA')
...
def aguardar_horario_entrada(_iq: IQ_Option, _pariedade: str) -> list:
    ...
    while True:
        ...
        if (6.59 <= minutos <= 7) or minutos == 1.59:
            return _iq.get_candles(_pariedade, 60, 3, time.time() - 240)
